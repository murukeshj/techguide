...
function comment_form( $args = array(), $post_id = null ) {
	...
	$defaults = array(
		'fields'               => $fields,
		'comment_field'        => '<p class="comment-form-comment"><label for="comment">' . _x( 'Comment', 'noun' ) . '</label> <textarea id="comment" name="comment" cols="45" rows="5" placeholder="type your comment..." aria-required="true"></textarea></p>',
